...
::: {.claim .warn}
After all 225k tokens, **47.7%** of the vocabulary is still words seen **exactly once**, and Good–Turing puts **2.9%** of the next token's mass on words never seen at all. Sparsity is a property of language, not a shortage of text.
:::
