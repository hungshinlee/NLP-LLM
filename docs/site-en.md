...
| **UDL** | Prince, *Understanding Deep Learning*, MIT Press; GitHub **v5.0.3, 2026-02-09**, ch 1–21, CC BY-NC-ND | **The best catch-up text for a class with no prerequisites**: free PDF, notebooks, slides and an answer booklet, and still maintained. The Week 1 handout [*Mathematical Prerequisites* (PDF)](handouts/w01-math-prerequisites.pdf) says which parts of it this course needs |
